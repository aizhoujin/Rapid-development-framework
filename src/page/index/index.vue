<template>
  <el-container class="avue-contail">
    ...
    <el-container>
      ...
      <el-main class="avue-main" ref="aaaa" id="box">
        <!-- 主体视图层 -->
    ...
    <!--<div style="position: fixed;right: 0px; top: 50%;width: 20px; height: 20px; background: red" @click="aa">11111</div>-->
...
export default {
  ...
  methods: {
    aa() {
      document.getElementById('box').addEventListener('scroll', this.handleScroll);
    },
    handleScroll() {
      console.log(1);
